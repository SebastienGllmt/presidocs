...
import { loadCaptureControls } from "./narratorDom.ts";
...
import { AuthorTools } from "./narrator/authorTools.ts";
...
export class Narrator {
  ...
  readonly authorTools = new AuthorTools(this);
  ...
  async init(pendingKey?: KeyboardEvent) {
    ...
    void this.authorTools.maybeEnableAuthorTools();
